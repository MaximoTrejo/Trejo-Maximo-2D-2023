...
namespace _1er_ParcialLabo
{
    ...
    public partial class Venta : Form
    {
        ...
        private void btnComprar_Click(object sender, EventArgs e)
        {
            ...
            string medioPago = cbxMediosPago.Text;
            medioPago = string.IsNullOrEmpty(medioPago) ? null : medioPago;
            //hago la suma total del carrito de compras 
            double SumaCarrito;
            SumaCarrito = datos.sumarImporte(datos.CarritoCompra);
            SumaCarrito = datos.PagoCreditoImporte(SumaCarrito, medioPago);
            //obtengo de mi lista carrito de compras el nombre , la cantidad y el precio por unidad
        ...
        private void EjecutarProceso(Facturacion ticket, double sumaCarrito)
        {
            ...
            {
                OperacionTerminada.Invoke(false);
            }
        }
